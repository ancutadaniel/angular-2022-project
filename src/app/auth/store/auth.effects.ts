...
const handleError = (errorRes: any) => {
  ...
  if (!errorRes.error || !errorRes.error.error) {
    return of(new AuthActions.AuthenticatedFailed(errorMessage));
  }
...
export class AuthEffects {
  ...
  // Actions is a big observable for dispatch actions
  @Effect()
  authLogin = this.actions$.pipe(
    ofType(AuthActions.LOGIN_START),
    // create new Observable by take another observable data
  ...
  authRedirect = this.actions$.pipe(
    ...
    tap((authSuccessAction: AuthActions.AuthenticatedSuccess) => {
